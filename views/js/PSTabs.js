...
;(function(window) {
	...
	PSTabs.prototype._init = function() {
		// get current index
		this.index = Number(document.URL.substring(document.URL.indexOf("#khalti_step_") + 13));
		// tabs elems
	...
	var div_3d = '- ' + Translation[3]+' </br>- '+Translation[0]+' </br>- '+Translation[1]+' </br>- '+Translation[2]+'<a href="" target="_blank"></a></div>';
